-- TABLE 1
IF OBJECT_ID('Mohre_Company_Employer', 'U') IS NULL
CREATE TABLE Mohre_Company_Employer (
...
-- TABLE 2
IF OBJECT_ID('Mohre_Company_Employer_WF', 'U') IS NULL
CREATE TABLE Mohre_Company_Employer_WF (
    ...
    First_User_Action_Date DATETIME2 NULL,
    Second_User_Action_Date DATETIME2 NULL,
