...
public class RetrieveWPSReportEmployeeResponse {

    private RetrieveWPSReportEmployeeResponseDetail responseDetail;

    @Data
    @AllArgsConstructor
    @NoArgsConstructor
    @JsonIgnoreProperties(ignoreUnknown = true)
    public static class RetrieveWPSReportEmployeeResponseDetail {
        private RespStatWsiRefNo respStat;
        private RetrieveWPSReportEmployeeResponseList responseList;
    }
    ...
    @NoArgsConstructor
    @JsonIgnoreProperties(ignoreUnknown = true)
    public static class RetrieveWPSReportEmployeeResponseList {
        private RetrieveWPSReportEmployeeWPSResponse response;
    }
    ...
    @NoArgsConstructor
    @JsonIgnoreProperties(ignoreUnknown = true)
    public static class RetrieveWPSReportEmployeeWPSResponse {
        private RetrieveWPSReportEmployeeRespData respData;
        private RespStat respStat;
        private RetrieveWPSReportEmployeeWsData wsData;
    }
    ...
    @NoArgsConstructor
    @JsonIgnoreProperties(ignoreUnknown = true)
    public static class RetrieveWPSReportEmployeeRespData {
    ...
    @NoArgsConstructor
    @JsonIgnoreProperties(ignoreUnknown = true)
    public static class RetrieveWPSReportEmployeeWsData {
        private String registrationNumber;
        private String employeeEIDA;
    }
}
