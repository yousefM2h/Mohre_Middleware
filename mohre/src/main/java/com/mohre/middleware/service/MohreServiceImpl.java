...
//		GetCompanyOrDomesticSponsorListRequest getCompanyOrDomesticSponsorListRequest= new GetCompanyOrDomesticSponsorListRequest();
//		try {
...
//					);
//			
//			CompanyOrDomesticSponsorListWebServiceInputDetails webserviceDetails = getCompanyOrDomesticSponsorListRequest.getWebServiceInputData().getWebServiceInputDetails();
//			
...
//					);
//			String jsonPayload = mapper.writeValueAsString(getCompanyOrDomesticSponsorListRequest);
//			EncryptedRequest encryptedRequest = null;//encryptionService.encryptRequest("046", "username", "password", jsonPayload);
//			
...
//		 apiRequest = new RegisteredEmployerDetailsRequest(registrationNo, emiratesId);
