...
//		ResponseEntity<GetCompanyListResponse> response = callRestPostAPI(uri, headers, requestBody, 
...
//	public <T> ResponseEntity<T> callRestGetAPI(URI uri, HttpHeaders headers, String json, Class<T> responseCls){
//		 HttpEntity<String> req = new HttpEntity<>(json, headers);
//		    ResponseEntity<T> response =  restTemplate.exchange(uri, HttpMethod.GET, req, responseCls);
//		    return response;
//	}
	
	public RegistrationCheckResponse callRegistrationCheckApi(CompanyOrDomesticSponsorListWebServiceData request)throws Exception {
