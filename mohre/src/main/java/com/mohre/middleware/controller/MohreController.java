...
//	    	CompanyListRespData companyListRespData =  mohreService.getCompanyDetails(request);
...
//	public ResponseEntity<?> getEmployerDetails(@RequestBody GetCompanyOrDomesticSponsorListRequest request) {
//		String registrationType = request.getWebServiceInputData().getWebServiceInputDetails().getWsDatalst()
...
//			return new ResponseEntity<>(HttpStatus.OK);
//		} else {
//			return ResponseEntity.badRequest().body("Invalid registration type: " + registrationType);
//		}
//	}
//
...
//
//		RegisteredEmployerDetailsResponse response = mohreService.getRegisteredEmployerDetails(request);
//		return new ResponseEntity<>(HttpStatus.OK);
//	}
//
//	@PostMapping("/updateRegisteredEmployer")
//	public ResponseEntity<UpdateRegisteredEmployerDetailsResponse> updateRegisteredEmployer(
//			@RequestBody UpdateRegisteredEmployerDetailsRequest request) {
//
//		UpdateRegisteredEmployerDetailsResponse response = mohreService.updateRegisteredEmployerDetails(request);
//		return new ResponseEntity<>(HttpStatus.OK);
//	}
//
//	@PostMapping("/retrieveActiveEmployee")
//	public ResponseEntity<RetreiveActiveEmployeeDetailsResponse> retrieveActiveEmployee(
//			@RequestBody RetrieveActiveEmployeeDetailsRequest request) {
//
//		RetreiveActiveEmployeeDetailsResponse response = mohreService.retrieveActiveEmployeeDetails(request);
//		return new ResponseEntity<>(HttpStatus.OK);
//	}
//
//	@PostMapping("/retrieveEmployeeUsingUN")
//	public ResponseEntity<RetrieveEmployeeDetailUsingUnifiedNumberResponse> retrieveEmployeeUsingUN(
...
//	public ResponseEntity<?> registerDomesticEmployer(@RequestBody RegisterDomesticEmployerRequest model) {
//		DomesticEmployementRegistrationResponse response = mohreService.registerDomesticEmployer(model);
//		return new ResponseEntity<>(HttpStatus.OK);
//	}
//
//	@PostMapping("/registerCompanyEmployer")
//	public ResponseEntity<CompanyEmployementRegistrationResponse> registerCompanyEmployer(@RequestBody RegisterCompanyEmployerRequest model) {
//		CompanyEmployementRegistrationResponse response = mohreService.registerCompanyEmployer(model);
//		return new ResponseEntity<>(HttpStatus.OK);
//	}
//
//	@PostMapping("/sendSalaryPaymentNotification")
//	public ResponseEntity<SalaryNotificationDetailResponse> sendSalaryNotification(@RequestBody SendSalaryNotificationDetailRequest model) {
//		SalaryNotificationDetailResponse response = mohreService.sendSalaryNotificationDetail(model);
//		return new ResponseEntity<>(HttpStatus.OK);
//	}
//
//	@PostMapping("/sendDomesticSalaryPaymentDetails")
//	public ResponseEntity<DomesticSalaryPaymentResponse> sendDomesticSalaryPaymentDetails(
//			@RequestBody SendDomesticSalaryPaymentDetailsRequest model) {
//		DomesticSalaryPaymentResponse respone = mohreService.sendDomesticSalaryPaymentDetails(model);
//		return new ResponseEntity<>(HttpStatus.OK);
//	}
//
//	@PostMapping("/sendCompanySalaryPaymentDetails")
//	    public ResponseEntity<CompanySalaryDetailResponse> sendCompanySalaryPaymentDetails(@RequestBody SendCompanySalaryPaymentDetailsRequest model) {
//	    	CompanySalaryDetailResponse reponse= mohreService.sendCompanySalaryPaymentDetails(model);
//	        return new ResponseEntity<>(HttpStatus.OK);
//	    }
